...
#     category = models.ForeignKey('Category', on_delete=models.CASCADE, related_name='category_for_the_auction',
#                                  default=1)
...
class AuctionsForm(ModelForm):
    class Meta:
        ...
        widgets = {'category': forms.Select(choices=[], attrs={'class': 'form-control'}),
